          ...
          {teams.map((team, i) => (
            ...
            >
              <Link
                ...
                className="inline-block px-4 py-2 rounded-full text-xs font-semibold border border-white/20 text-white/70 hover:text-white hover:border-white/50 hover:bg-white/10 transition-all"
              >
